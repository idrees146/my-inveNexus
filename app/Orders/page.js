...
<div className="orders md:p-4 w-full absolute text-gray-950  md:w-[79vw] md:h-[90vh]  top-12 left-0  md:left-[20vw]">



<section class="bg-white dark:bg-dark py-4 lg:py-20">
