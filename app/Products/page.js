    ...
    return (
        <>
            ...
            <div className=" w-full absolute     md:w-[79vw] md:h-[90vh]  top-12 left-0  md:left-[20vw] ">
                ...
                <button onClick={toggleProduct} className='text-white bg-green-950 md:bg-gray-950 p-1 px-2 rounded mt-7 ml-3 hover:bg-green-900 md:hover:bg-gray-900' >New Product
